...
@section('title', 'Edit Banner - Kabby Admin')
                            ...
                            <form action="{{ route('banner.update', $banner) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="order" name="order" value="{{ old('order', $banner->order) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if($banner->image_path)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $banner->image_path) }}" alt="Banner Image" class="img-thumbnail mt-2" style="max-height: 150px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
