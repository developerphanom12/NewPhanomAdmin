            ...
            <div class="col-md-12">
               <div class="d-flex justify-content-between align-items-center flex-wrap">
                  <div>
                     ...
                     <p>This is Currencies Detalis.</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-sm-12">
            <div class="card">
               <div class="card-header d-flex">
                  ...
                  <div class="header-title m-3">
                     <a href="{{ route('screen.currencies.createcurrencies') }}" class="btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3 text-center">
                        <i class="btn-inner">
                           <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                           </svg>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="flex align-items-center list-user-action">
                                    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{route('screen.currencies.editcurrencies')}}">
