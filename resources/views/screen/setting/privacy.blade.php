                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                ...
                                <p>Manage your Privacy Policy.</p>
                            </div>
                            <div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('setting.privacy.update') }}">
                                    @csrf
                                    <textarea id="privacy-editor" name="content">
                                       {!! $policy->value ?? '<p>Write your privacy policy here...</p>' !!}
                                    </textarea>
...
@push('scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/4dhqkp9cwhk26suhazxk3gse36c9sthuavbh3moj4fmr2cmd/tinymce/6/tinymce.min.js"
