...
@section('title', 'Edit Tax - Kabby Admin')
                   ...
                   <div class="card">
                      <div class="card-header d-flex justify-content-between">
                         <div class="header-title">
                            <h4 class="card-title">Edit Tax Details</h4>
                         </div>
                      </div>
                      <div class="card-body">
                            ...
                            <div class="row">
                               <div class="col-md-6 mb-3">
                                  ...
                                  <input type="text" class="form-control @error('tax_title') is-invalid @enderror" 
                                         id="tax_title" name="tax_title" value="{{ old('tax_title', $tax->tax_title) }}" required>
                                  @error('tax_title')
                                ...
                                <div class="form-group">
                                    <select class="form-select" id="country" name="country" required>
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country['code'] }}" {{ old('country', $tax->country) == $country['code'] ? 'selected' : '' }}>
                                                {{ $country['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                             ...
                             <div class="col-md-6 form-group mb-3">
                                ...
                                <div class="form-group">
                                    <select class="form-select @error('tax_type') is-invalid @enderror" 
                                       ...
                                       <option value="fixed" {{ old('tax_type', $tax->tax_type) == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                       <option value="percentage" {{ old('tax_type', $tax->tax_type) == 'percentage' ? 'selected' : '' }}>Percentage</option>
                                    </select>
                                    @error('tax_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                             ...
                             <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('tax_amount') is-invalid @enderror" 
                                       id="tax_amount" name="tax_amount" value="{{ old('tax_amount', $tax->tax_amount) }}" required>
                                @error('tax_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                             </div>
                                  ...
                                  <div class="checkbox mb-3">
                                     <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_active" 
                                               id="is_active" value="1" {{ old('is_active', $tax->is_active) ? 'checked' : '' }}>
