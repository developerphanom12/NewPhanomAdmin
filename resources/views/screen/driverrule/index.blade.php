@extends('layouts.app')
@section('title', 'Driver Rules - Kabby Admin')
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h1>Driver Rules</h1>
                            <p>Manage all driver rules and compliance policies.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Driver Rules</h4>
                        </div>
                        <div>
                            <a href="{{ route('driver-rules.create') }}" class="btn btn-primary">
                                <i class="fas fa-plus-circle me-2"></i>Create Driver Rule
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip" 
                                                       data-bs-placement="top" title="View" href="{{ route('driver-rules.show', $rule) }}">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" 
                                                       data-bs-placement="top" title="Edit" href="{{ route('driver-rules.edit', $rule) }}">
                                                       <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <form action="{{ route('driver-rules.destroy', $rule) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center">No driver rules found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
