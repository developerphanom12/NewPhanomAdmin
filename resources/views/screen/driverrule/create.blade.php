...
@section('title', 'Create Driver Rule - Kabby Admin')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h1>Create Driver Rule</h1>
                            <p>Add a new rule for drivers to follow.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Create Driver Rule</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            @if(session('success'))
                            ...
                            <form method="POST" action="{{ route('driver-rules.store') }}">
                                @csrf
                                <div class="row">
