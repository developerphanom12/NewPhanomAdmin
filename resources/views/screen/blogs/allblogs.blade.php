            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex">
                     ...
                     <div class="header-title m-3">
                        <a href="{{ route('screen.blogs.allblogs.addblog') }}" class="btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3 text-center">
                           <i class="btn-inner">
                              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                              </svg>
                     ...
                     <div class="table-responsive">
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                           ...
                           <tbody>
                              <tr>
                                 <td>
                                    <img src="{{ asset('images/blog/01.jpg') }}" class="rounded" alt="blog thumbnail" style="width: 100px; height: 60px; object-fit: cover;">
                                 </td>
                                 <td>Getting Started with Laravel 10</td>
                                 <td><span class="badge bg-success py-2">Published</span></td>
                                 <td>2024-03-20</td>
                                 <td>
                                    <div class="flex align-items-center list-user-action">
                                 <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Add"  href="{{route('screen.blogs.allblogs.view')}}">
                                 ...
                                 <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"  href="{{route('screen.blogs.allblogs.view')}}">
                                    <span class="btn-inner">
                                       <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
