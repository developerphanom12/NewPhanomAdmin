                     ...
                     <div class="card">
                         ...
                         <form id="form-wizard1" class="mt-3 text-center">
                             <ul id="top-tab-list" class="p-0 row list-inline">
                                 <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
                                     <a href="javascript:void();">
                                         <div class="iq-icon me-1">
                                             <svg class="svg-icon icon-20" xmlns="http://www.w3.org/2000/svg"  width="15" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" />
                                             </svg>                                        
                                         </div>
                                         <span class="dark-wizard">Basic Information</span>
                                     </a>
                                 </li>
                                 <li id="personal" class="mb-2 col-lg-3 col-md-6 text-start">
                                     <a href="javascript:void();">
                                         ...
                                         <span class="dark-wizard">Meta Information</span>
                                     </a>
                                 </li>
                                 <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
                                     <a href="javascript:void();">
                                         ...
                                         <span class="dark-wizard">Description</span>
                                     </a>
                                 </li>
                                 <li id="confirm" class="mb-2 col-lg-3 col-md-6 text-start">
                                     <a href="javascript:void();">
                                         ...
                                         <span class="dark-wizard">Additional</span>
                                     </a>
                                 </li>
                             </ul>
                             <!-- fieldsets -->
                                 ...
                                 <div class="form-card text-start">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="email" class="form-control" name="email" placeholder="Enter Blog Title" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                 ...
                                 <div class="form-card text-start">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="fname" placeholder="Enter Meta Title" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                             ...
                             <fieldset>
                                ...
                                <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next" >Submit</button>
                                {{-- <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous" >Previous</button> --}}
