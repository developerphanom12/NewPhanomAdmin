                  ...
                  <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">View Blog Details</h4>
                        </div>
                        <a href="{{route('screen.blogs.allblogs.editblogs')}}">Edit</a>
                    </div>
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="exampleInputurl">Meta title</label>
